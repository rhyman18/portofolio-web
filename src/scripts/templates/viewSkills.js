/**
 * Skeleton placeholder tiles for skills while loading.
...
/**
 * Render a skill tile with optional certificate popover target.
 * @param {object} skill Skill entry
 * @param {string} skill.id Unique identifier
 * @param {string} skill.name Skill name
 * @param {string} [skill.icon] Inline SVG markup
 * @param {string} [skill.cert_link] Certificate link target
 * @param {string} [skill.cert_img] Certificate image URL
 * @return {string} HTML string
 */
...
/**
 * Render a certificate popover content block for a skill.
 * @param {object} skill Skill entry (expects cert_link, cert_img, cert_desc)
 * @return {string} HTML string
 */
